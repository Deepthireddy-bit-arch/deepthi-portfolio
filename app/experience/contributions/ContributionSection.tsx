...
// // const PHONES = [
// //   { src: '/images/app-screens.png', label: 'Task App' },
// //   { src: '/images/learnexa.png',    label: 'Quiz Platform' },
// //   { src: '/images/app-screens.png', label: 'Happiness App' },
// // ]
// const PHONES = [
//   { src: '/assets/images/dementia.jpg',    label: 'Dementia Detection' },
//   { src: '/assets/images/collegefest.jpg', label: 'College Fest' },
//   { src: '/assets/images/netflix.jpg',     label: 'Netflix Clone' },
// ]
...
//             <strong>Recognised at Q3 team review.</strong>
//             {' '}Praised for proactive ownership, clear communication, and delivering
//             features with minimal back-and-forth — stood out as a reliable contributor
//             in the first year.
//           </div>
//         </div> */}
...
export default function ContributionsSection() {
  ...
  // ── Mobile: IntersectionObserver adds .isVisible to phones + cards ─────────
  // GSAP float animation is skipped on mobile (matchMedia guard).
  // CSS handles the fade-up transition via .isVisible class.
  useEffect(() => {
